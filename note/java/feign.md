...
这是 feign 提供的具有当前关键功能的地图：![MindMap overview](http://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/OpenFeign/feign/master/src/docs/overview-mindmap.iuml)

### 基本

用法通常看起来像这样，是对[规范 Retrofit 样本](https://github.com/square/retrofit/blob/master/samples/src/main/java/com/example/retrofit/SimpleService.java)的改编。
